...
namespace Our.Umbraco.OpeningHours.Model.Offset {
    ...
    public class OpeningHoursDayOffset {
        ...
        /// </summary>
        public OpeningHoursDayTimeSlotOffset[] Items { get; private set; }

        #endregion

        #region Constructors

        public OpeningHoursDayOffset(DateTimeOffset date, OpeningHoursWeekdayItem weekday, OpeningHoursHolidayItem holiday) {
            Date = date;
            Weekday = weekday;
            Holiday = holiday;
