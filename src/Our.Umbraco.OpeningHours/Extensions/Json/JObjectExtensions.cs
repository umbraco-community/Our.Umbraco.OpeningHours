...
namespace Our.Umbraco.OpeningHours.Extensions.Json {
    
    /// <summary>
    /// Various extensions methods for <see cref="JObject"/> that makes manual parsing easier.
    /// </summary>
    /// <see>
    ///     <cref>https://github.com/abjerner/Skybrud.Social/blob/master/src/Skybrud.Social.Core/Json/Extensions/JObjectExtensions.cs</cref>
    /// </see>
